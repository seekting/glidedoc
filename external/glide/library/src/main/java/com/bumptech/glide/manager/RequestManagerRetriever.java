...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private RequestManager getApplicationManager(Context context) {
        ...
        if (applicationManager == null) {
            Log.d("seekting", "RequestManagerRetriever.getApplicationManager()获取的是app的requestManager 重新new");
            synchronized (this) {
                if (applicationManager == null) {
        ...
        Log.d("seekting", "RequestManagerRetriever.getApplicationManager() 获取的是app的requestManager");
