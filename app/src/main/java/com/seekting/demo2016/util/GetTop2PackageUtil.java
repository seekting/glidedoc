...
@SuppressLint("NewApi")
public class GetTop2PackageUtil {
    ...
    public GetTop2PackageUtil(Context context) {
    ...
    private String getRunningTasksTopPackage() throws Exception {
        ...
        try {
            taskList = activityManager.getRunningTasks(2);
        } catch (Exception e) {
        }
        if (taskList != null && !taskList.isEmpty()) {
            String topAppPkg = taskList.get(1).topActivity.getPackageName();
            return topAppPkg;
        }
        return "";
    }
